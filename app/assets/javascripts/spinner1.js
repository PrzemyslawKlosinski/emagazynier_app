...
spinbutton.prototype.handleMouseDown = function(e, $button) {
  ...
  if ($button.attr('id') == this.upID) {
    $img.attr('src', "images/button-arrow-up-pressed-hl.png");
  }
  else {
    $img.attr('src', "images/button-arrow-down-pressed-hl.png");
  }
...
spinbutton.prototype.handleMouseUp = function(e, $button) {
  ...
  if ($button.attr('id') == this.upID) {
    $img.attr('src', "images/button-arrow-up-hl.png");
  }
  else {
    $img.attr('src', "images/button-arrow-down-hl.png");
  }
...
spinbutton.prototype.handleMouseOut = function(e, $button) {
  ...
  if ($button.attr('id') == this.upID) {
    $img.attr('src', "images/button-arrow-up.png");
  }
  else {
    $img.attr('src', "images/button-arrow-down.png");
  }
