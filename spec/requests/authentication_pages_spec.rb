...
describe "Authentykacja - strona logowania" do
	...
	describe "with invalid information" do
		...
		it { should have_selector('title', text: 'Logowanie') }
		# it { should have_selector('div.alert.alert-error', text: 'Nieudane') }
		# WYKORZYSTUJEMY metode zdefiniowana w spec/support/utilities.rb
		it { should have_error_message('Nieudane') }
		it { should_not have_selector('a href', text: 'Ustawienia') }
...
describe "authorization" do
	...
	describe "for non-signed-in users" do
		...
		#jesli uzytkownik jest niezalogowany nie pozwol wykonac create destroy produkt
...
describe "as wrong user" do
	...
	describe "visiting Users#edit page" do
		...
		it { should_not have_selector('title', text: caly_tytul('Ustawienia')) }
	end
